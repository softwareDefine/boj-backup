            ...
            if(f.a*g.b - g.a*f.b == 0){
                if( vc[i].second.first == vc[j].second.first){
                 if(abs((vc[i].second.second-vc[j].second.second)) % 2 == 0){
                         mp[{abs(vc[i].second.second-vc[j].second.second)/2,{vc[i].second.first,(vc[i].second.second+vc[j].second.second)/2}}].insert(i);
                         mp[{abs(vc[i].second.second-vc[j].second.second)/2,{vc[i].second.first,(vc[i].second.second+vc[j].second.second)/2}}].insert(j);
                 }
                }else if( vc[i].second.second == vc[j].second.second){
                    if(abs((vc[i].second.first-vc[j].second.first)) % 2 == 0){
                            mp[{abs(vc[i].second.first-vc[j].second.first)/2,{(vc[i].second.first+vc[j].second.first)/2,vc[i].second.second}}].insert(i);
                            mp[{abs(vc[i].second.first-vc[j].second.first)/2,{(vc[i].second.first+vc[j].second.first)/2,vc[i].second.second}}].insert(j);
                    }
                }
                continue;
            }else{
