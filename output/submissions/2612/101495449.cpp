    ...
    for(int i = 1; i<= str1.size() + str2.size()-2; i++){
        for(int first = 0; first <= i; first++){
            ...
            if(first % 2 == 1 && second % 2 == 1){
                ...
                if(first + 2 < str1.size() && second + 2 < str2.size() && dp[first+2][second+2] < dp[first][second]+ (str1[first+2] == str2[second+2]?3:0)){
                    dp[first+2][second+2] = max(dp[first+2][second+2], dp[first][second]+ (str1[first+2] == str2[second+2]?3:0));
                ...
                if(first + 2 < str1.size() && second + 1 < str2.size() && dp[first+2][second+1] < dp[first][second]+ (str1[first+2] == str2[second+1]?3:0)){
                    dp[first+2][second+1] = max(dp[first+2][second+1], dp[first][second]+ (str1[first+2] == str2[second+1]?3:0));
                    before[first+2][second+1] = {first,second};
                }
                ...
                if(first + 1 < str1.size() && second + 2 < str2.size() && dp[first+1][second+2] < dp[first][second]+ (str1[first+1] == str2[second+2]?3:0)){
                    dp[first+1][second+2] = max(dp[first+1][second+2],dp[first][second]+ (str1[first+1] == str2[second+2]?3:0));
                    before[first+1][second+2] = {first,second};
                }
            }
        }
