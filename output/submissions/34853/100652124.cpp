...
bool finder(int idx, int a, int b, int c, int j){
    ...
    int aBigger2 = upper_bound(arr[a].begin(),arr[a].end(),stand-1) - arr[a].begin();
    int bBigger2 = upper_bound(arr[b].begin(),arr[b].end(),stand-1) - arr[b].begin();
    int cBigger2 = upper_bound(arr[c].begin(),arr[c].end(),stand-1) - arr[c].begin();
